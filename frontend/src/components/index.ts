...
export { PageBackgroundImageWrapper, PageBaseWrapper, TypographyWrapper, FlexCenterWrapper, OptionsCenterWrapper, Title, AdjustableTypography, SmallDeviceMediaQuery } from './Styled';
